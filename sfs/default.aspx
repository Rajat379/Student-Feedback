...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label 
                    ...
                    Text="Welcome to Student Feedback System " 
    ...
    <table class="style2" style="height: 202px; width: 607px; margin-right: 56px">
        <tr>
            ...
            <td class="style5" style="width: 189px">
                <asp:LinkButton ID="LinkButton2" PostBackUrl="coordinatorlogin.aspx" runat="server">COORDINATOR LOGIN</asp:LinkButton>
            </td>
            <td class="style9">
                &nbsp;</td>
        </tr>
        <tr>
            <td class="style10">
                &nbsp;<asp:LinkButton ID="LinkButton3" PostBackUrl="facultylogin.aspx" runat="server">FACULTY LOGIN</asp:LinkButton>
            </td>
            <td class="style5" style="width: 189px">
