                ...
                <tr>
                    <td align="right" style="height: 27px; " colspan="4">
                        ...
                        <asp:RadioButtonList ID="RadioButtonList2" runat="server" AutoPostBack="True" 
                            ...
                            <asp:ListItem Value="2">M.Tech(CST)</asp:ListItem>
                            <asp:ListItem Value="1">M.Tech(CCT)</asp:ListItem>
                    ...
                    <td align="left" style="height: 27px; width: 681px;">
                        <asp:DropDownList ID="DDLBName" runat="server" AutoPostBack="True" 
                           ...
                           <%-- onselectedindexchanged="DDLBName_SelectedIndexChanged">--%>
                            ...
                            <asp:ListItem>Computer Application(MCA)</asp:ListItem>
                            <asp:ListItem>Computer Science &amp; Technology(M.Tech)</asp:ListItem>
                            <asp:ListItem>Computer Cognition Technology(M.Tech)</asp:ListItem>
                        </asp:DropDownList>
