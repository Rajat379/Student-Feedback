<%@ Page Language="C#" MasterPageFile="~/coordinatorMasterPage.master" AutoEventWireup="true" CodeFile="AssignSubject.aspx.cs" Inherits="Administrator_AssignSubject" Title="Student Feedback System" %>
                        ...
                        <asp:RadioButtonList ID="RadioButtonList1" runat="server" AutoPostBack="True" 
                            ...
                            <asp:ListItem>MBA</asp:ListItem>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                        ...
                                        SelectCommand="Select id,name from Courses" 
                           ...
                           >
                            ...
                            <RowStyle BackColor="#E3EAEB" />
                             <Columns>
                                 ...
                                 <asp:BoundField DataField="name1" HeaderText="Semester" 
                                     SortExpression="name1" />
                                 <asp:BoundField DataField="name2" HeaderText="Subject" SortExpression="name2" />
                                 <asp:BoundField DataField="name3" HeaderText="Faculty" SortExpression="name3" />
                            </Columns>
