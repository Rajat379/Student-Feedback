...
public partial class login:System.Web.UI.Page
{
    ...
    protected void Login_Button_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        string checkuser = " select count(*) from Students where email = '" + lusername.Text + "' ";
        ...
        if (temp == 1)
        {
            ...
            conn.Open();
            string checkPasswordQuery = "select password from Students where email = '" + lusername.Text + "' ";
