<%@ Page Language="C#" AutoEventWireup="true" CodeFile="coordinatorlogin.aspx.cs" Inherits="login" MasterPageFile="~/LoginMasterPage.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 

 <div class="style1">
    
        <strong style="text-align: center">COORDINATOR LOGIN PAGE</strong></div>
